...
Uses:
 - Base JADES catalog with RA_TARG, Dec_TARG, z_best
 - CANDELS 3D tracers: RA, DEC, z
 - GOODS-S mask defined by 2D polygons

Method: identical to the CEERS approach used in Paper I.
"""
...
def compute_LOS(ra_b, dec_b, z_b, ext_ra, ext_dec, ext_z, polygons):
    ...
    # Identify which polygon contains the target
    poly_target = None
